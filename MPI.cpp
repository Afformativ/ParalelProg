...
std::mt19937 gen(time(0)); //base for the generator

int jacobinew(long long k, long long n) {
    int jac = 1;
    if (k < 0) {
        k = -k;
        if (n % 4 == 3)
...
//NEEDED: MAKE SCATTER OR SOMETHING for iterat distribution DONE
